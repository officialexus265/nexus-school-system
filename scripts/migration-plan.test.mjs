...
/** Repo root — this file lives one level down, in scripts/. */
...
test("the auth schema ships outside the globbed directory", () => {
  ...
  // The non-recursive glob never surfaces the auth/ subdirectory itself.
  assert.ok(!pending.some((m) => m.name === "auth"));
